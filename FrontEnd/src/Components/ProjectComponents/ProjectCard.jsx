...
const ProjectCard = ({ studentId }) => {
    ...
    return (
        <>
            ...
            {projects.length > 0 ? (<div className="all_projects_container text-white px-2 m-3  flex flex-col font-overpass items-center justify-center py-9 gap-5 shadow-sm shadow-gray-300 rounded-md bg-gray-200 ">
                {/* heding part */}
