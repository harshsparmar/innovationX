...
const Login = () => {
    ...
    return (
        <>
           ...
           <form action="" className="create_form mt-[-10px] w-[30rem] h-[480px] px-16 flex flex-col gap-5 py-9 bg-white rounded-xl shadow-lg" >
                <div className="email_box flex flex-col gap-2 text-black">
...
<path d="M12.1992 12C14.9606 12 17.1992 9.76142 17.1992 7C17.1992 4.23858 14.9606 2 12.1992 2C9.43779 2 7.19922 4.23858 7.19922 7C7.19922 9.76142 9.43779 12 12.1992 12Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
 <path d="M3 22C3.57038 20.0332 4.74796 18.2971 6.3644 17.0399C7.98083 15.7827 9.95335 15.0687 12 15C16.12 15 19.63 17.91 21 22" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className="w-full h-12 rounded-xl flex justify-center items-center font-medium   text-white gap-2.5  cursor-pointer transition duration-200 ease-in-out ">
          <button className=" btn google mt-0 w-full h-12 rounded-xl flex justify-center items-center font-medium  border border-[#ededef] bg-[#151717] text-white gap-2.5  cursor-pointer transition duration-200 ease-in-out">
...
<path fill="#fbc02d" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12	s5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24s8.955,20,20,20	s20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z"></path><path fill="#e53935" d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039	l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z"></path><path fill="#4caf50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36	c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z"></path><path fill="#1565c0" d="M43.611,20.083L43.595,20L42,20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571	c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
           ...
           {/* <button className="btn github mt-0.4 w-full h-12 rounded-xl flex justify-center items-center font-medium gap-2.5 border border-[#ededef] bg-[#151717] text-white  cursor-pointer transition duration-200 ease-in-out">
